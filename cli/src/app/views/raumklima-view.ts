/**
 * Raumklima view — live indoor-climate sensor readings (temperature, humidity,
 * CO₂) anchored to rooms. Placeholder for the v3 redesign: the Home Assistant
 * adapter (readings stored as anchored DocEntries) is staged separately; this
 * view currently only announces the section and reacts to the shared document.
 */
  ...
  private render(): void {
    ...
    this.setChild(
      new Adw.StatusPage({
        ...
        title: 'Raumklima',
        description: hasDoc
          ? 'Keine Sensoren verbunden — Home-Assistant-Anbindung in Arbeit.'
